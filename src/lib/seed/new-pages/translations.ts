...
const CAREERS: Record<LocaleCode, CareersStrings> = {
  'zh-CN': {
    ...
    howWeWork: [
      ...
      { title: '为长远而做', body: '工作室是自筹资金的,不出售。我们打算把这家公司做一百二十年。这意味着稳定的节奏、真正的周末,以及选择那些随时间复利的问题。这里没人在为退出而冲刺。' },
  ...
  es: {
    ...
    howWeWork: [
      ...
      { title: 'Hechos para el largo plazo', body: 'El estudio es bootstrapped y no está en venta. Planeamos seguir lanzando dentro de ciento veinte años. Eso significa un ritmo estable, fines de semana de verdad y elegir problemas que se acumulan con el tiempo. Aquí nadie corre hacia una salida.' },
  ...
  hi: {
    ...
    howWeWork: [
      ...
      { title: 'लंबे खेल के लिए बना', body: 'स्टूडियो बूटस्ट्रैप्ड है और बिक्री के लिए नहीं है। हम एक सौ बीस साल में शिप करने की योजना बनाते हैं। इसका मतलब स्थिर गति, असली सप्ताहांत, और ऐसी समस्याएँ चुनना जो समय के साथ संयोजित होती हैं। यहाँ कोई एग्ज़िट के लिए नहीं दौड़ रहा।' },
  ...
  ar: {
    ...
    howWeWork: [
      ...
      { title: 'مصنوع للعب الطويل', body: 'الاستوديو مُموَّل ذاتيًا وغير معروض للبيع. نخطط أن نُطلِق بعد مئة وعشرين عامًا. هذا يعني وتيرة ثابتة، عطلات نهاية أسبوع حقيقية، واختيار مشاكل تتراكم مع الزمن. لا أحد هنا في سباق نحو الخروج.' },
  ...
  fr: {
    ...
    howWeWork: [
      ...
      { title: 'Faits pour la durée', body: "Le studio est bootstrapped et pas à vendre. Nous prévoyons de livrer dans cent vingt ans. Cela veut dire un rythme régulier, de vrais week-ends et choisir des problèmes qui composent dans le temps. Personne ici ne court vers une sortie." },
  ...
  pt: {
    ...
    howWeWork: [
      ...
      { title: 'Feitos para o jogo longo', body: 'O estúdio é bootstrapped e não está à venda. Planeamos continuar a entregar daqui a cento e vinte anos. Isso significa um ritmo constante, fins de semana a sério e escolher problemas que se acumulam ao longo do tempo. Ninguém aqui está a correr para uma saída.' },
  ...
  bn: {
    ...
    howWeWork: [
      ...
      { title: 'দীর্ঘ খেলার জন্য তৈরি', body: 'স্টুডিওটি বুটস্ট্র্যাপড এবং বিক্রির জন্য নয়। আমরা একশ বিশ বছর পরে শিপ করার পরিকল্পনা করি। এর মানে স্থির গতি, প্রকৃত উইকেন্ড, এবং এমন সমস্যা বেছে নেওয়া যা সময়ের সাথে সংযুক্ত হয়। এখানে কেউ এক্সিটের দিকে দৌড়াচ্ছে না।' },
  ...
  ru: {
    ...
    howWeWork: [
      ...
      { title: 'Сделано для долгой игры', body: 'Студия начата на свои средства и не продаётся. Мы планируем выпускать продукты ещё через сто двадцать лет. Это значит ровный темп, настоящие выходные и выбор задач, которые накапливаются со временем. Здесь никто не бежит к выходу.' },
  ...
  ur: {
    ...
    howWeWork: [
      ...
      { title: 'طویل کھیل کے لیے بنا', body: 'اسٹوڈیو خود سے فنڈڈ ہے اور برائے فروخت نہیں۔ ہم ایک سو بیس سال میں شپ کرنے کا منصوبہ بناتے ہیں۔ اس کا مطلب ہے مستحکم رفتار، حقیقی ویک اینڈز، اور ایسے مسائل کا انتخاب جو وقت کے ساتھ جمع ہوتے ہیں۔ یہاں کوئی ایگزٹ کی طرف نہیں دوڑ رہا۔' },
  ...
  id: {
    ...
    howWeWork: [
      ...
      { title: 'Dibuat untuk permainan panjang', body: 'Studio ini bootstrapped dan tidak dijual. Kami berencana terus mengirim selama seratus dua puluh tahun. Itu berarti ritme yang stabil, akhir pekan yang nyata, dan memilih masalah yang menumpuk seiring waktu. Tidak ada di sini yang berlari menuju exit.' },
  ...
  sw: {
    ...
    howWeWork: [
      ...
      { title: 'Imeundwa kwa mchezo mrefu', body: 'Studio imejifadhili na haiuzwi. Tunapanga kuendelea kutuma kwa miaka mia moja na ishirini. Hiyo ina maana mwendo thabiti, wikendi za kweli, na kuchagua matatizo yanayoongezeka kwa muda. Hapa hakuna anayekimbilia kutoka.' },
  ...
  yo: {
    ...
    howWeWork: [
      ...
      { title: 'Tí a ṣe fún ìṣeré gígùn', body: 'Studio náà jẹ́ tí a fúnra-rẹ̀ ṣètilẹ́yìn, kì í sì í ṣe fún títà. A ń pinnu láti tẹ̀síwájú láti jádelé fún ọgọ́fà ọdún. Èyí túmọ̀ sí ọkà tí ó dúró ṣinṣin, ìparí ọṣẹ̀ tí ó jẹ́ tòótọ́, àti yíyàn àwọn ìṣòro tí ń pọ̀ síi pẹ̀lú àkókò. Kò sí ẹnikẹ́ni níbí tí ó ń sáré sí ìjáde.' },
  ...
  ha: {
    ...
    howWeWork: [
      ...
      { title: 'An gina don dogon wasa', body: 'Studio yana da kuɗin kansa kuma ba a sayar da shi ba. Muna shirin ci gaba da aikawa shekaru ɗari da ashirin masu zuwa. Wannan yana nufin sannu-sannu mai ɗorewa, ƙarshen mako na hakika, da zaɓen matsalolin da ke girma da lokaci. Babu wanda ke gudu zuwa fita anan.' },
  ...
  'zh-CN': {
    ...
    sectionItems: [
      [
        ...
        { q: '你们是风险投资支持的初创公司吗?', a: '不是。我们自筹资金、自助创业。这意味着我们对用户负责,而不是对追逐快速退出的投资者。我们交付较慢,但计划存在一百二十年。公司不出售。' },
        ...
        { q: '为什么叫"母公司"——这是控股结构吗?', a: '它是简单意义上的母公司。一个法律实体拥有这一系列平台。清单:Clappe、ClapBill、ClapMed、ClapDiet、ClapMove、ClapPay、Clapwork、Apogee、Audiflo、Nestbitt、DailyWorship、Gclap、FileManager、RateAds / Feedback Hub,加上共享基础设施。每个产品都有自己的网站。每个都有自己的条款和价格。法律所有者是 Intelligent Singularity Inc.。' },
  ...
  es: {
    ...
    sectionItems: [
      [
        ...
        { q: '¿Sois una startup respaldada por capital riesgo?', a: 'No. Somos autofinanciados y bootstrapped. Eso significa que respondemos a los usuarios, no a inversores que persiguen salidas rápidas. Tardamos más en lanzar y planeamos estar aquí dentro de ciento veinte años. La empresa no está en venta.' },
  ...
  hi: {
    ...
    sectionItems: [
      [
        ...
        { q: 'क्या आप उद्यम-समर्थित स्टार्टअप हैं?', a: 'नहीं। हम स्व-वित्तपोषित और बूटस्ट्रैप्ड हैं। इसका मतलब है हम उपयोगकर्ताओं को जवाबदेह हैं, उन निवेशकों को नहीं जो जल्दी एग्ज़िट का पीछा करते हैं। हम शिप करने में अधिक समय लेते हैं और एक सौ बीस साल बाद भी रहने की योजना बनाते हैं। कंपनी बिक्री के लिए नहीं है।' },
        ...
        { q: '"मूल कंपनी" क्यों — क्या यह एक होल्डिंग संरचना है?', a: 'यह सादे अर्थ में मूल कंपनी है। एक कानूनी इकाई प्लेटफ़ॉर्म के परिवार की मालिक है। सूची: Clappe, ClapBill, ClapMed, ClapDiet, ClapMove, ClapPay, Clapwork, Apogee, Audiflo, Nestbitt, DailyWorship, Gclap, FileManager, RateAds / Feedback Hub, साथ ही साझा बुनियादी ढाँचा। हर उत्पाद अपनी साइट पर चलता है। हर एक के अपने नियम और कीमतें हैं। कानूनी मालिक Intelligent Singularity Inc. है।' },
  ...
  ar: {
    ...
    sectionItems: [
      [
        ...
        { q: 'هل أنتم شركة ناشئة مدعومة برأس مال جريء؟', a: 'لا. نحن مموَّلون ذاتيًا وbootstrapped. وهذا يعني أننا نُجيب أمام المستخدمين، لا أمام مستثمرين يلاحقون خروجًا سريعًا. يستغرقنا الإطلاق وقتًا أطول، ونخطط للبقاء بعد مئة وعشرين عامًا. الشركة ليست للبيع.' },
  ...
  pt: {
    ...
    sectionItems: [
      [
        ...
        { q: 'São uma startup apoiada por venture capital?', a: 'Não. Somos autofinanciados e bootstrapped. Isso significa que respondemos a utilizadores, não a investidores que perseguem saídas rápidas. Demoramos mais a lançar, e planeamos estar por aqui daqui a cento e vinte anos. A empresa não está à venda.' },
  ...
  bn: {
    ...
    sectionItems: [
      [
        ...
        { q: 'আপনারা কি ভেঞ্চার-সমর্থিত স্টার্টআপ?', a: 'না। আমরা স্ব-অর্থায়িত এবং বুটস্ট্র্যাপড। এর অর্থ আমরা ব্যবহারকারীদের কাছে দায়বদ্ধ, দ্রুত এক্সিটের পেছনে ছুটে যাওয়া বিনিয়োগকারীদের কাছে নয়। আমরা শিপ করতে বেশি সময় নিই, এবং একশ বিশ বছর পরেও থাকার পরিকল্পনা করি। কোম্পানি বিক্রির জন্য নয়।' },
        ...
        { q: '"মূল কোম্পানি" কেন — এটি কি একটি হোল্ডিং কাঠামো?', a: 'এটি সাধারণ অর্থে একটি মূল কোম্পানি। একটি আইনি সত্তা প্ল্যাটফর্ম পরিবারের মালিক। তালিকা: Clappe, ClapBill, ClapMed, ClapDiet, ClapMove, ClapPay, Clapwork, Apogee, Audiflo, Nestbitt, DailyWorship, Gclap, FileManager, RateAds / Feedback Hub, প্লাস ভাগাভাগি অবকাঠামো। প্রতিটি পণ্য তার নিজস্ব সাইটে চলে। প্রত্যেকটির নিজস্ব শর্তাবলী এবং মূল্য আছে। আইনি মালিক Intelligent Singularity Inc.।' },
  ...
  ru: {
    ...
    sectionItems: [
      [
        ...
        { q: 'Вы стартап, поддержанный венчурным капиталом?', a: 'Нет. Мы самофинансируемые и bootstrapped. Это значит, что мы отвечаем перед пользователями, а не перед инвесторами, гоняющимися за быстрым выходом. Релизы занимают больше времени, и мы планируем быть здесь и через сто двадцать лет. Компания не продаётся.' },
  ...
  ur: {
    ...
    sectionItems: [
      [
        ...
        { q: 'کیا آپ وینچر-بیکڈ اسٹارٹ اپ ہیں؟', a: 'نہیں۔ ہم خود فنڈڈ اور بوٹسٹریپڈ ہیں۔ اس کا مطلب ہے کہ ہم صارفین کو جوابدہ ہیں، تیز ایگزٹ کا پیچھا کرنے والے سرمایہ کاروں کو نہیں۔ ہم شپ کرنے میں زیادہ وقت لیتے ہیں، اور ایک سو بیس سال بعد بھی موجود رہنے کا منصوبہ بناتے ہیں۔ کمپنی برائے فروخت نہیں۔' },
        ...
        { q: '"پیرنٹ کمپنی" کیوں — کیا یہ ایک ہولڈنگ سٹرکچر ہے؟', a: 'یہ سادے معنوں میں پیرنٹ کمپنی ہے۔ ایک قانونی ادارہ پلیٹ فارمز کے خاندان کا مالک ہے۔ فہرست: Clappe، ClapBill، ClapMed، ClapDiet، ClapMove، ClapPay، Clapwork، Apogee، Audiflo، Nestbitt، DailyWorship، Gclap، FileManager، RateAds / Feedback Hub، اور مشترکہ بنیادی ڈھانچہ۔ ہر پروڈکٹ اپنی سائٹ پر چلتی ہے۔ ہر ایک کی اپنی شرائط اور قیمتیں ہیں۔ قانونی مالک Intelligent Singularity Inc. ہے۔' },
  ...
  id: {
    ...
    sectionItems: [
      [
        ...
        { q: 'Apakah Anda startup yang didukung modal ventura?', a: 'Tidak. Kami self-funded dan bootstrapped. Itu berarti kami bertanggung jawab kepada pengguna, bukan kepada investor yang mengejar exit cepat. Kami butuh waktu lebih lama untuk merilis, dan kami berencana ada di sini seratus dua puluh tahun lagi. Perusahaan tidak dijual.' },
  ...
  sw: {
    ...
    sectionItems: [
      [
        ...
        { q: 'Je, ni startup inayoungwa mkono na mtaji wa hatari?', a: 'Hapana. Tumejifadhili na bootstrapped. Hiyo inamaanisha tunajibu kwa watumiaji, sio kwa wawekezaji wanaofuatilia kutoka kwa haraka. Tunachukua muda mrefu kutuma, na tunapanga kuwepo miaka mia moja na ishirini ijayo. Kampuni haiuzwi.' },
  ...
  yo: {
    ...
    sectionItems: [
      [
        ...
        { q: 'Ǹjẹ́ ẹ̀yin jẹ́ startup tí ó gba ìtìlẹ́yìn venture?', a: 'Bẹ́ẹ̀kọ́. A jẹ́ tí ara wa ti ṣètilẹ́yìn àti bootstrapped. Èyí túmọ̀ sí pé a ń jíhìn fún àwọn olùmújáde, kì í ṣe fún àwọn olùdòwó tí ń lépa ìjáde kíákíá. A gba àkókò gígùn láti jádelé, a sì ń pinnu láti wà níbí lẹ́yìn ọgọ́fà ọdún. Kampani náà kò sí fún títà.' },
        ...
        { q: 'Kí ló dé tí "kampani ìyá" — Ǹjẹ́ ó jẹ́ ẹ̀dà holding?', a: 'Ó jẹ́ kampani ìyá ní àpẹrẹ rírọrùn. Ẹgbẹ́ òfin kan ni o ní ìdílé pèpéle. Àkójọ: Clappe, ClapBill, ClapMed, ClapDiet, ClapMove, ClapPay, Clapwork, Apogee, Audiflo, Nestbitt, DailyWorship, Gclap, FileManager, RateAds / Feedback Hub, plus ìpilẹ̀ṣẹ̀ àjọṣe. Ọjà kọ̀ọ̀kan ń ṣiṣẹ́ lórí ojú-òpó tirẹ̀. Ọ̀kọ̀ọ̀kan ní àwọn àdéhùn àti iye-owó tirẹ̀. Olùní òfin ni Intelligent Singularity Inc.' },
