...
const SECURITY: Record<LocaleCode, SecurityStrings> = {
  'zh-CN': {
    ...
    topStats: [
      { label: '跟踪器', value: '0', hint: '在本站和每个产品页面上' },
      { label: '第三方调用', value: '0', hint: '每次提交由 CI 强制执行' },
  ...
  es: {
    ...
    topStats: [
      { label: 'Rastreadores', value: '0', hint: 'En este sitio y en cada página de producto' },
      { label: 'Llamadas a terceros', value: '0', hint: 'Aplicado por CI en cada commit' },
  ...
  hi: {
    ...
    topStats: [
      { label: 'ट्रैकर', value: '0', hint: 'इस साइट पर और हर उत्पाद पृष्ठ पर' },
      { label: 'तृतीय-पक्ष कॉल', value: '0', hint: 'हर कमिट पर CI द्वारा लागू' },
  ...
  ar: {
    ...
    topStats: [
      { label: 'متتبعات', value: '0', hint: 'على هذا الموقع وعلى كل صفحة منتج' },
      { label: 'مكالمات لطرف ثالث', value: '0', hint: 'يُفرَض بواسطة CI في كل التزام' },
  ...
  fr: {
    ...
    topStats: [
      { label: 'Trackers', value: '0', hint: 'Sur ce site et sur chaque page produit' },
      { label: 'Appels tiers', value: '0', hint: 'Appliqué par la CI à chaque commit' },
  ...
  pt: {
    ...
    topStats: [
      { label: 'Rastreadores', value: '0', hint: 'Neste site e em cada página de produto' },
      { label: 'Chamadas a terceiros', value: '0', hint: 'Aplicado por CI a cada commit' },
  ...
  bn: {
    ...
    topStats: [
      { label: 'ট্র্যাকার', value: '0', hint: 'এই সাইটে এবং প্রতিটি পণ্য পৃষ্ঠায়' },
      { label: 'তৃতীয়-পক্ষ কল', value: '0', hint: 'প্রতিটি কমিটে CI দ্বারা প্রয়োগ করা' },
  ...
  ru: {
    ...
    topStats: [
      { label: 'Трекеры', value: '0', hint: 'На этом сайте и на каждой странице продукта' },
      { label: 'Вызовы сторонних', value: '0', hint: 'Принудительно проверяется CI на каждом коммите' },
  ...
  ur: {
    ...
    topStats: [
      { label: 'ٹریکرز', value: '0', hint: 'اس سائٹ پر اور ہر پروڈکٹ پیج پر' },
      { label: 'تھرڈ-پارٹی کالز', value: '0', hint: 'ہر کمٹ پر CI کے ذریعے نافذ' },
  ...
  id: {
    ...
    topStats: [
      { label: 'Pelacak', value: '0', hint: 'Di situs ini dan setiap halaman produk' },
      { label: 'Panggilan pihak ketiga', value: '0', hint: 'Ditegakkan oleh CI pada setiap commit' },
  ...
  sw: {
    ...
    topStats: [
      { label: 'Wafuatiliaji', value: '0', hint: 'Kwenye tovuti hii na kila ukurasa wa bidhaa' },
      { label: 'Simu za nje', value: '0', hint: 'Inatekelezwa na CI kwenye kila commit' },
  ...
  yo: {
    ...
    topStats: [
      { label: 'Awọn olùtọpa', value: '0', hint: 'Lórí ojú-òpó yìí àti gbogbo ojú-ìwé ọjà' },
      { label: 'Àwọn ìpè ẹgbẹ́ kẹta', value: '0', hint: 'A fi sílẹ̀ lágbára nípa CI ní ìṣètò kọ̀ọ̀kan' },
  ...
  ha: {
    ...
    topStats: [
      { label: 'Masu bibiya', value: '0', hint: 'A kan wannan shafin da kuma a kowane shafin samfuri' },
      { label: 'Kira na ɓangare na uku', value: '0', hint: 'An aiwatar da shi ta CI a kowane commit' },
  ...
  'zh-CN': {
    ...
    sectionItems: [
      [
        ...
        { q: '团队有多大?', a: '足够小,新员工在第一周就认识每一张脸,但又足够大,能让十几个平台持续交付。具体人数在 /press 的新闻情况说明书中。我们刻意不做规模竞赛;AI 代理结构在真正的意义上是团队的一部分。' },
      ],
      [
      ...
      [
        { q: '你们在这个网站上跟踪我吗?', a: '不。本站零分析、零像素、零追踪 Cookie、零广告网络、零第三方内容。我们看到的唯一数据是你输入联系表单并点击发送的内容。一个名为 no-third-party.mjs 的持续集成脚本会在任何外部主机出现在 bundle 中时阻止发布。' },
        { q: '我的数据存在哪里?', a: '当你联系我们时,你的消息通过电子邮件发送到加拿大艾伯塔省的自托管收件箱。我们不在本站的数据库中存储它。产品特定数据(当你注册我们的某个工具时)在该产品自己域名上的隐私政策中描述。' },
  ...
  es: {
    ...
    sectionItems: [
      [
        ...
        { q: '¿Cómo de grande es el equipo?', a: 'Lo bastante pequeño para que un nuevo fichaje aprenda cada cara la primera semana, lo bastante grande para mantener más de una docena de plataformas en producción. La cifra exacta está en la hoja de prensa en /press. Deliberadamente no anunciamos una carrera de tamaño; el tejido de agentes IA es parte del equipo en sentido real.' },
      ],
      [
      ...
      [
        { q: '¿Me rastreáis en este sitio web?', a: 'No. Este sitio tiene cero analíticas, cero píxeles, cero cookies de seguimiento, cero redes de publicidad y cero contenido de terceros. Los únicos datos que vemos son los que escribes en el formulario de contacto y envías. Un script de integración continua llamado no-third-party.mjs bloquea el lanzamiento si aparece cualquier host externo en el bundle.' },
        { q: '¿Dónde se almacenan mis datos?', a: 'Cuando nos contactas, tu mensaje se envía por correo a una bandeja autoalojada en Alberta, Canadá. No lo guardamos en una base de datos en este sitio. Los datos específicos del producto (cuando te registras en una de nuestras herramientas) se describen en la política de privacidad de ese producto en su propio dominio.' },
  ...
  hi: {
    ...
    sectionItems: [
      [
        ...
        { q: 'टीम कितनी बड़ी है?', a: 'इतनी छोटी कि एक नया कर्मचारी पहले हफ़्ते में हर चेहरा सीख ले, इतनी बड़ी कि एक दर्जन से अधिक प्लेटफ़ॉर्म शिपिंग होते रहें। सटीक संख्या /press पर प्रेस तथ्य पत्रक में है। हम जानबूझकर आकार की दौड़ का विज्ञापन नहीं करते; AI-एजेंट फ़ैब्रिक एक वास्तविक अर्थ में टीम का हिस्सा है।' },
      ],
      [
  ...
  ar: {
    ...
    sectionItems: [
      [
        ...
        { q: 'كم حجم الفريق؟', a: 'صغير بما يكفي ليتعلم الموظف الجديد كل وجه في الأسبوع الأول، كبير بما يكفي ليُبقي أكثر من اثنتي عشرة منصة تُطلق. العدد الدقيق في ورقة الحقائق الصحفية على /press. نتعمد عدم الترويج لسباق الحجم؛ بنية وكلاء الذكاء الاصطناعي جزء حقيقي من الفريق.' },
      ],
      [
      ...
      [
        { q: 'هل تتعقّبونني على هذا الموقع؟', a: 'لا. لهذا الموقع صفر تحليلات، صفر بكسلات، صفر ملفات تعريف ارتباط للتعقّب، صفر شبكات إعلانات، وصفر محتوى من أطراف ثالثة. البيانات الوحيدة التي نراها هي ما تكتبه في نموذج الاتصال وتضغط إرسال. سكربت تكامل مستمر اسمه no-third-party.mjs يحجب الإصدار إذا ظهر أي مضيف خارجي في الحزمة.' },
        { q: 'أين تُخزَّن بياناتي؟', a: 'حين تراسلنا، تُرسَل رسالتك بالبريد إلى صندوق وارد ذاتي الاستضافة في ألبرتا، كندا. لا نُخزّنها في قاعدة بيانات على هذا الموقع. تُوصَف بيانات المنتج المخصصة (عند تسجيلك في إحدى أدواتنا) في سياسة خصوصية ذلك المنتج على نطاقه الخاص.' },
  ...
  fr: {
    ...
    sectionItems: [
      [
        ...
        { q: "Quelle est la taille de l'équipe ?", a: "Assez petite pour qu'une nouvelle recrue apprenne chaque visage en première semaine, assez grande pour faire tourner plus d'une douzaine de plateformes. Le chiffre exact est sur la fiche presse à /press. Nous ne faisons délibérément pas la course à la taille ; le tissu d'agents IA fait partie de l'équipe au sens réel." },
      ],
      [
      ...
      [
        { q: 'Me suivez-vous sur ce site ?', a: "Non. Ce site n'a aucune analytique, aucun pixel, aucun cookie de tracking, aucun réseau publicitaire, et aucun contenu de tiers. Les seules données que nous voyons sont celles que vous tapez dans le formulaire de contact et envoyez. Un script d'intégration continue appelé no-third-party.mjs bloque la livraison si un hôte externe apparaît dans le bundle." },
        { q: 'Où mes données sont-elles stockées ?', a: "Quand vous nous contactez, votre message est envoyé par email à une boîte auto-hébergée en Alberta, au Canada. Nous ne le stockons pas dans une base de données sur ce site. Les données spécifiques au produit (quand vous vous inscrivez à l'un de nos outils) sont décrites dans la politique de confidentialité de ce produit sur son propre domaine." },
  ...
  pt: {
    ...
    sectionItems: [
      [
        ...
        { q: 'Que tamanho tem a equipa?', a: 'Pequena o suficiente para que uma nova contratação aprenda cada cara na primeira semana, grande o suficiente para manter mais de uma dúzia de plataformas em produção. O número exato está na ficha de imprensa em /press. Deliberadamente não fazemos uma corrida ao tamanho; o tecido de agentes IA faz parte da equipa em sentido real.' },
      ],
      [
  ...
  bn: {
    ...
    sectionItems: [
      [
        ...
        { q: 'দলটি কত বড়?', a: 'এত ছোট যে একজন নতুন নিয়োগপ্রাপ্ত প্রথম সপ্তাহে প্রতিটি মুখ শিখে যান, এত বড় যে এক ডজনেরও বেশি প্ল্যাটফর্ম শিপিং চলমান থাকে। সঠিক সংখ্যা /press-এ প্রেস ফ্যাক্ট শিটে আছে। আমরা ইচ্ছাকৃতভাবে আকারের প্রতিযোগিতা প্রচার করি না; AI-এজেন্ট ফ্যাব্রিক প্রকৃত অর্থে দলের একটি অংশ।' },
      ],
      [
      ...
      [
        { q: 'আপনি কি এই ওয়েবসাইটে আমাকে ট্র্যাক করেন?', a: 'না। এই সাইটের শূন্য অ্যানালিটিক্স, শূন্য পিক্সেল, শূন্য ট্র্যাকিং কুকিজ, শূন্য বিজ্ঞাপন নেটওয়ার্ক এবং তৃতীয় পক্ষের শূন্য সামগ্রী আছে। আমরা কেবল সেই ডেটা দেখি যা আপনি যোগাযোগ ফর্মে টাইপ করেন এবং পাঠান। no-third-party.mjs নামক একটি ক্রমাগত একীকরণ স্ক্রিপ্ট বান্ডলে কোনো বাহ্যিক হোস্ট দেখা গেলে রিলিজ ব্লক করে।' },
        { q: 'আমার ডেটা কোথায় সংরক্ষিত?', a: 'যখন আপনি আমাদের সাথে যোগাযোগ করেন, আপনার বার্তা ইমেইলের মাধ্যমে কানাডার আলবার্টায় একটি স্ব-হোস্টেড ইনবক্সে পাঠানো হয়। আমরা এটিকে এই সাইটের একটি ডেটাবেসে সংরক্ষণ করি না। পণ্য-নির্দিষ্ট ডেটা (যখন আপনি আমাদের একটি সরঞ্জামের জন্য সাইন আপ করেন) সেই পণ্যের নিজস্ব গোপনীয়তা নীতিতে তার নিজস্ব ডোমেইনে বর্ণিত আছে।' },
  ...
  ru: {
    ...
    sectionItems: [
      [
        ...
        { q: 'Какого размера команда?', a: 'Достаточно маленькая, чтобы новый сотрудник за первую неделю узнал каждое лицо, достаточно большая, чтобы поддерживать выпуск более дюжины платформ. Точная численность — в пресс-факт-листе на /press. Мы намеренно не устраиваем гонку размеров; фабрика ИИ-агентов — часть команды в реальном смысле.' },
      ],
      [
      ...
      [
        { q: 'Вы отслеживаете меня на этом сайте?', a: 'Нет. На этом сайте ноль аналитики, ноль пикселей, ноль трекинговых кук, ноль рекламных сетей и ноль контента от третьих сторон. Единственные данные, которые мы видим, — это то, что вы вводите в форму контактов и отправляете. CI-скрипт под названием no-third-party.mjs блокирует релиз, если в бандле появляется любой внешний хост.' },
        { q: 'Где хранятся мои данные?', a: 'Когда вы пишете нам, ваше сообщение отправляется по почте в самохостируемый ящик в Альберте, Канада. Мы не храним его в базе данных на этом сайте. Продуктовые данные (когда вы регистрируетесь в одном из инструментов) описаны в политике приватности этого продукта на его собственном домене.' },
  ...
  ur: {
    ...
    sectionItems: [
      [
        ...
        { q: 'ٹیم کتنی بڑی ہے؟', a: 'اتنی چھوٹی کہ نئی بھرتی پہلے ہفتے میں ہر چہرہ سیکھ لے، اتنی بڑی کہ درجن سے زیادہ پلیٹ فارمز شپنگ جاری رکھ سکیں۔ صحیح تعداد /press پر پریس فیکٹ شیٹ میں ہے۔ ہم جان بوجھ کر سائز کی دوڑ کا اعلان نہیں کرتے؛ AI-ایجنٹ فیبرک حقیقی معنوں میں ٹیم کا حصہ ہے۔' },
      ],
      [
  ...
  id: {
    ...
    sectionItems: [
      [
        ...
        { q: 'Seberapa besar tim?', a: 'Cukup kecil sehingga karyawan baru mempelajari setiap wajah di minggu pertama, cukup besar untuk menjaga lebih dari selusin platform tetap dirilis. Jumlah pasti ada di lembar fakta pers di /press. Kami sengaja tidak mengiklankan perlombaan ukuran; jaringan agen AI adalah bagian dari tim dalam arti yang sebenarnya.' },
      ],
      [
  ...
  sw: {
    ...
    sectionItems: [
      [
        ...
        { q: 'Timu ina ukubwa gani?', a: 'Ndogo vya kutosha mwajiriwa mpya kujifunza kila uso katika wiki ya kwanza, kubwa vya kutosha kuendelea kutuma majukwaa zaidi ya kumi na mbili. Idadi halisi iko katika karatasi ya ukweli wa vyombo vya habari kwenye /press. Tunafanya kwa makusudi tusitangaze mbio za ukubwa; kitambaa cha mawakala wa AI ni sehemu ya timu kwa maana halisi.' },
      ],
      [
  ...
  yo: {
    ...
    sectionItems: [
      [
        ...
        { q: 'Báwo ni ẹgbẹ́ ṣe tóbi tó?', a: 'Kéré tó pé tí ọmọ-iṣẹ́ tuntun lè kọ́ ojú kọ̀ọ̀kan ní ọ̀sẹ̀ àkọ́kọ́, tóbi tó pé láti pa àwọn pèpéle tí ó ju mejìlá lọ jádelé. Iye gangan wà nínú ìwé-òṣùwọ̀n ti ìròyìn lórí /press. A pinnu láti má ṣe ìpolongò ìdíje ìwọ̀n; kítísì àwọn aṣojú AI jẹ́ ara ẹgbẹ́ ní àpẹrẹ gidi.' },
      ],
      [
      ...
      [
        { q: 'Ǹjẹ́ ẹ̀yin ń tọpinpin mi lórí ojú-òpó yìí?', a: 'Bẹ́ẹ̀kọ́. Ojú-òpó yìí ní àfọkàn-mọ́ òfo, ìpín-òṣùwọ̀n òfo, kúkì ìtọpinpin òfo, nẹ́tíwọ́kì ìpolongò òfo, àti ohun-ìní lati ọ̀dọ̀ àwọn ẹgbẹ́ kẹta òfo. Déètà nikan tí a rí ni ohun tí o tẹ̀ sí inú fọ́ọ̀mù ìbárasọ̀rọ̀ àti tí o tẹ̀ ránṣẹ́. Ìwé ìpapọ̀ tí ń tẹ̀síwájú tí orúkọ rẹ̀ ní no-third-party.mjs ń di ìfilọ̀ tí ó bá ní agbalejò òde tí ó han nínú àkójọpọ̀.' },
        { q: 'Níbo ni a ti ń pa déètà mi mọ́?', a: 'Nígbà tí o bá tako wa, àkọsílẹ̀ rẹ ni a fi ìmẹ́ìlì ránṣẹ́ sí àpótí gbígba ti a fi ìpamọ́ ṣe ní Alberta, Canada. A kì í pa á mọ́ nínú ipilẹ̀ déètà lórí ojú-òpó yìí. Déètà pàtó-sí-ọjà (nígbà tí o bá fọwọ́sí ọ̀kan lára àwọn ohun-èlò wa) ni a sọ̀rọ̀ rẹ̀ nínú ìlànà àṣírí ọjà yẹn lórí àpá-ìwé tirẹ̀.' },
  ...
  ha: {
    ...
    sectionItems: [
      [
        ...
        { q: 'Yaya girman ƙungiyar?', a: "Ƙarama isasshe sabon ɗan aiki zai koyi kowace fuska a sati na farko, babba isasshe don ci gaba da aika dandamali sama da goma sha biyu. Adadin ainihi yana cikin takardar gaskiyar 'yan jarida a /press. Da gangan ba mu yin tallar tseren girma; yadudduka na wakilan AI wani ɓangare ne na ƙungiya a ma'ana ta hakika." },
      ],
      [
      ...
      [
        { q: 'Shin kuna bibiyar ni akan wannan shafin yanar gizo?', a: "A'a. Wannan shafin yana da sifili na nazari, sifili na pixels, sifili na cookies na bibiya, sifili na hanyoyin tallace-tallace, da sifili na abun ciki daga ɓangare na uku. Bayanan kawai da muke gani su ne abin da kuke buga a cikin fom ɗin tuntuɓa kuma ku danna aika. Wani rubutu na ci gaba da haɗawa mai suna no-third-party.mjs yana toshe fitarwa idan wani mai dauke da bayanai na waje ya fito a cikin bundle." },
        { q: 'Ina aka ajiye bayanaina?', a: "Lokacin da kuka tuntuɓe mu, an aika saƙon ku ta imel zuwa wani akwatin saƙo da aka ɗauki nauyin sa kanta a Alberta, Kanada. Ba mu ajiye shi cikin database akan wannan shafin ba. An bayyana bayanai masu alaƙa da samfurin (lokacin da kuka yi rajista don ɗaya daga cikin kayan aikinmu) a cikin manufofin sirri na samfurin akan yankinsa." },
