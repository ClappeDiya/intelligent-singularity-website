...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_trust_page_pillars_key" AS ENUM('security', 'privacy', 'sustainability', 'accessibility', 'finance');
  ...
  CREATE TABLE "trust_page_pillars" (
  	...
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"key" "enum_trust_page_pillars_key" NOT NULL,
  	"href" varchar NOT NULL
  );
  ...
  CREATE TABLE "careers_page_how_we_work" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL
  );
  
  CREATE TABLE "careers_page_how_we_work_locales" (
  	"title" varchar NOT NULL,
  	"body" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "careers_page_product_family" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL
  );
  
  CREATE TABLE "careers_page_product_family_locales" (
  	"name" varchar NOT NULL,
  ...
  CREATE TABLE "careers_page_process" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL
  );
  
  CREATE TABLE "careers_page_process_locales" (
  ...
  CREATE TABLE "careers_page" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"introduce_yourself_email" varchar NOT NULL,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  
  CREATE TABLE "careers_page_locales" (
  	"eyebrow" varchar DEFAULT 'Careers · Join the studio' NOT NULL,
  	"title" varchar NOT NULL,
  	"lede" varchar NOT NULL,
  	"openings_heading" varchar DEFAULT 'Currently hiring for…' NOT NULL,
  	"openings_currently_hiring_text" varchar NOT NULL,
  	"openings_note" varchar NOT NULL,
  	"introduce_yourself_eyebrow" varchar DEFAULT 'Introduce yourself anyway' NOT NULL,
  	"introduce_yourself_heading" varchar NOT NULL,
  	"introduce_yourself_body" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  );
  
  CREATE TABLE "press_page_fact_sheet" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL
  );
  
  CREATE TABLE "press_page_fact_sheet_locales" (
  	"label" varchar NOT NULL,
  	"value" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "press_page_quotes" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL
  );
  
  CREATE TABLE "press_page_quotes_locales" (
  ...
  CREATE TABLE "press_page_story_angles_yes" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL
  );
  
  CREATE TABLE "press_page_story_angles_yes_locales" (
  	"title" varchar NOT NULL,
  	"body" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "press_page_story_angles_no" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL
  );
  
  CREATE TABLE "press_page_story_angles_no_locales" (
  	"title" varchar NOT NULL,
  	"body" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "press_page" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"contact_cta_email" varchar NOT NULL,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  
  CREATE TABLE "press_page_locales" (
  	"eyebrow" varchar DEFAULT 'Press · Media room' NOT NULL,
  	"title" varchar NOT NULL,
  	"lede" varchar NOT NULL,
  	"boilerplate" varchar NOT NULL,
  	"brand_guidance_brand_name" varchar NOT NULL,
  	"brand_guidance_founder_reference" varchar NOT NULL,
  	"contact_cta_eyebrow" varchar DEFAULT 'Direct contact' NOT NULL,
  	"contact_cta_heading" varchar NOT NULL,
  	"contact_cta_body" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  );
  
  CREATE TABLE "security_page_top_stats" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL
  );
  
  CREATE TABLE "security_page_top_stats_locales" (
  	"label" varchar NOT NULL,
  	"value" varchar NOT NULL,
  ...
  CREATE TABLE "security_page_posture" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL
  );
  
  CREATE TABLE "security_page_posture_locales" (
  	"title" varchar NOT NULL,
  	"body" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "security_page_data_handling" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL
  );
  
  CREATE TABLE "security_page_data_handling_locales" (
  	"title" varchar NOT NULL,
  	"body" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "security_page_compliance" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL
  );
  
  CREATE TABLE "security_page_compliance_locales" (
  	"title" varchar NOT NULL,
  	"body" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "security_page" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"report_cta_email" varchar NOT NULL,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  
  CREATE TABLE "security_page_locales" (
  	"eyebrow" varchar DEFAULT 'Security · Trust · Data' NOT NULL,
  	"title" varchar NOT NULL,
  	"lede" varchar NOT NULL,
  	"posture_summary_eyebrow" varchar DEFAULT 'Posture summary' NOT NULL,
  	"posture_summary_heading" varchar NOT NULL,
  	"posture_summary_body" varchar NOT NULL,
  	"report_cta_eyebrow" varchar DEFAULT 'Report a vulnerability' NOT NULL,
  	"report_cta_heading" varchar NOT NULL,
  	"report_cta_body" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  );
  
  CREATE TABLE "pricing_page_principles" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar NOT NULL
  ...
  CREATE TABLE "pricing_page_principles_locales" (
  	"title" varchar NOT NULL,
  	"body" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "pricing_page_anti_patterns" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL
  );
  
  CREATE TABLE "pricing_page_anti_patterns_locales" (
  	"title" varchar NOT NULL,
  	"body" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "pricing_page_worked_example" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL
  );
  
  CREATE TABLE "pricing_page_worked_example_locales" (
  	"who" varchar NOT NULL,
  ...
  CREATE TABLE "pricing_page_locales" (
  	"eyebrow" varchar DEFAULT 'Pricing · Our six rules' NOT NULL,
  	"title" varchar NOT NULL,
  	"lede" varchar NOT NULL,
  	"why_this_exists_eyebrow" varchar DEFAULT 'Why this exists' NOT NULL,
  	"why_this_exists_heading" varchar NOT NULL,
  	"why_this_exists_body" varchar NOT NULL,
  	"why_this_exists_free_tier_line" varchar NOT NULL,
  	"why_this_exists_paid_tier_line" varchar NOT NULL,
  	"why_this_exists_enterprise_line" varchar NOT NULL,
  	"see_prices_cta_eyebrow" varchar DEFAULT 'See actual prices' NOT NULL,
  	"see_prices_cta_heading" varchar NOT NULL,
  	"see_prices_cta_body" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  );
  
  CREATE TABLE "faq_page_sections_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL
  );
  
  CREATE TABLE "faq_page_sections_items_locales" (
  	"q" varchar NOT NULL,
  	"a" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "faq_page_sections_locales" (
  	"title" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  ...
  CREATE TABLE "faq_page" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"still_stuck_cta_email" varchar NOT NULL,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  
  CREATE TABLE "faq_page_locales" (
  	"eyebrow" varchar DEFAULT 'FAQ · Plain answers' NOT NULL,
  	"title" varchar NOT NULL,
  	"lede" varchar NOT NULL,
  	"still_stuck_cta_eyebrow" varchar DEFAULT 'Still have a question?' NOT NULL,
  	"still_stuck_cta_heading" varchar NOT NULL,
  	"still_stuck_cta_body" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  );
  ...
  ALTER TABLE "careers_page_how_we_work" ADD CONSTRAINT "careers_page_how_we_work_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."careers_page"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "careers_page_how_we_work_locales" ADD CONSTRAINT "careers_page_how_we_work_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."careers_page_how_we_work"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "careers_page_product_family" ADD CONSTRAINT "careers_page_product_family_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."careers_page"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "careers_page_product_family_locales" ADD CONSTRAINT "careers_page_product_family_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."careers_page_product_family"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "careers_page_process" ADD CONSTRAINT "careers_page_process_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."careers_page"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "careers_page_process_locales" ADD CONSTRAINT "careers_page_process_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."careers_page_process"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "press_page_fact_sheet" ADD CONSTRAINT "press_page_fact_sheet_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."press_page"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "press_page_fact_sheet_locales" ADD CONSTRAINT "press_page_fact_sheet_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."press_page_fact_sheet"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "press_page_quotes" ADD CONSTRAINT "press_page_quotes_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."press_page"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "press_page_quotes_locales" ADD CONSTRAINT "press_page_quotes_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."press_page_quotes"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "press_page_story_angles_yes" ADD CONSTRAINT "press_page_story_angles_yes_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."press_page"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "press_page_story_angles_yes_locales" ADD CONSTRAINT "press_page_story_angles_yes_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."press_page_story_angles_yes"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "press_page_story_angles_no" ADD CONSTRAINT "press_page_story_angles_no_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."press_page"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "press_page_story_angles_no_locales" ADD CONSTRAINT "press_page_story_angles_no_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."press_page_story_angles_no"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "security_page_top_stats" ADD CONSTRAINT "security_page_top_stats_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."security_page"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "security_page_top_stats_locales" ADD CONSTRAINT "security_page_top_stats_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."security_page_top_stats"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "security_page_posture" ADD CONSTRAINT "security_page_posture_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."security_page"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "security_page_posture_locales" ADD CONSTRAINT "security_page_posture_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."security_page_posture"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "security_page_data_handling" ADD CONSTRAINT "security_page_data_handling_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."security_page"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "security_page_data_handling_locales" ADD CONSTRAINT "security_page_data_handling_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."security_page_data_handling"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "security_page_compliance" ADD CONSTRAINT "security_page_compliance_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."security_page"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "security_page_compliance_locales" ADD CONSTRAINT "security_page_compliance_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."security_page_compliance"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "security_page_locales" ADD CONSTRAINT "security_page_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."security_page"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pricing_page_principles" ADD CONSTRAINT "pricing_page_principles_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pricing_page"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pricing_page_principles_locales" ADD CONSTRAINT "pricing_page_principles_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pricing_page_principles"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pricing_page_anti_patterns" ADD CONSTRAINT "pricing_page_anti_patterns_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pricing_page"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pricing_page_anti_patterns_locales" ADD CONSTRAINT "pricing_page_anti_patterns_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pricing_page_anti_patterns"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pricing_page_worked_example" ADD CONSTRAINT "pricing_page_worked_example_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pricing_page"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pricing_page_worked_example_locales" ADD CONSTRAINT "pricing_page_worked_example_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pricing_page_worked_example"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "faq_page_sections_items" ADD CONSTRAINT "faq_page_sections_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."faq_page_sections"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "faq_page_sections_items_locales" ADD CONSTRAINT "faq_page_sections_items_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."faq_page_sections_items"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "faq_page_sections" ADD CONSTRAINT "faq_page_sections_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."faq_page"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "faq_page_sections_locales" ADD CONSTRAINT "faq_page_sections_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."faq_page_sections"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "careers_page_how_we_work_order_idx" ON "careers_page_how_we_work" USING btree ("_order");
  CREATE INDEX "careers_page_how_we_work_parent_id_idx" ON "careers_page_how_we_work" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "careers_page_how_we_work_locales_locale_parent_id_unique" ON "careers_page_how_we_work_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "careers_page_product_family_order_idx" ON "careers_page_product_family" USING btree ("_order");
  CREATE INDEX "careers_page_product_family_parent_id_idx" ON "careers_page_product_family" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "careers_page_product_family_locales_locale_parent_id_unique" ON "careers_page_product_family_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "careers_page_process_order_idx" ON "careers_page_process" USING btree ("_order");
  CREATE INDEX "careers_page_process_parent_id_idx" ON "careers_page_process" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "careers_page_process_locales_locale_parent_id_unique" ON "careers_page_process_locales" USING btree ("_locale","_parent_id");
  CREATE UNIQUE INDEX "careers_page_locales_locale_parent_id_unique" ON "careers_page_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "press_page_fact_sheet_order_idx" ON "press_page_fact_sheet" USING btree ("_order");
  CREATE INDEX "press_page_fact_sheet_parent_id_idx" ON "press_page_fact_sheet" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "press_page_fact_sheet_locales_locale_parent_id_unique" ON "press_page_fact_sheet_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "press_page_quotes_order_idx" ON "press_page_quotes" USING btree ("_order");
  CREATE INDEX "press_page_quotes_parent_id_idx" ON "press_page_quotes" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "press_page_quotes_locales_locale_parent_id_unique" ON "press_page_quotes_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "press_page_story_angles_yes_order_idx" ON "press_page_story_angles_yes" USING btree ("_order");
  CREATE INDEX "press_page_story_angles_yes_parent_id_idx" ON "press_page_story_angles_yes" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "press_page_story_angles_yes_locales_locale_parent_id_unique" ON "press_page_story_angles_yes_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "press_page_story_angles_no_order_idx" ON "press_page_story_angles_no" USING btree ("_order");
  CREATE INDEX "press_page_story_angles_no_parent_id_idx" ON "press_page_story_angles_no" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "press_page_story_angles_no_locales_locale_parent_id_unique" ON "press_page_story_angles_no_locales" USING btree ("_locale","_parent_id");
  CREATE UNIQUE INDEX "press_page_locales_locale_parent_id_unique" ON "press_page_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "security_page_top_stats_order_idx" ON "security_page_top_stats" USING btree ("_order");
  CREATE INDEX "security_page_top_stats_parent_id_idx" ON "security_page_top_stats" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "security_page_top_stats_locales_locale_parent_id_unique" ON "security_page_top_stats_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "security_page_posture_order_idx" ON "security_page_posture" USING btree ("_order");
  CREATE INDEX "security_page_posture_parent_id_idx" ON "security_page_posture" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "security_page_posture_locales_locale_parent_id_unique" ON "security_page_posture_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "security_page_data_handling_order_idx" ON "security_page_data_handling" USING btree ("_order");
  CREATE INDEX "security_page_data_handling_parent_id_idx" ON "security_page_data_handling" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "security_page_data_handling_locales_locale_parent_id_unique" ON "security_page_data_handling_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "security_page_compliance_order_idx" ON "security_page_compliance" USING btree ("_order");
  CREATE INDEX "security_page_compliance_parent_id_idx" ON "security_page_compliance" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "security_page_compliance_locales_locale_parent_id_unique" ON "security_page_compliance_locales" USING btree ("_locale","_parent_id");
  CREATE UNIQUE INDEX "security_page_locales_locale_parent_id_unique" ON "security_page_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "pricing_page_principles_order_idx" ON "pricing_page_principles" USING btree ("_order");
  CREATE INDEX "pricing_page_principles_parent_id_idx" ON "pricing_page_principles" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "pricing_page_principles_locales_locale_parent_id_unique" ON "pricing_page_principles_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "pricing_page_anti_patterns_order_idx" ON "pricing_page_anti_patterns" USING btree ("_order");
  CREATE INDEX "pricing_page_anti_patterns_parent_id_idx" ON "pricing_page_anti_patterns" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "pricing_page_anti_patterns_locales_locale_parent_id_unique" ON "pricing_page_anti_patterns_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "pricing_page_worked_example_order_idx" ON "pricing_page_worked_example" USING btree ("_order");
  CREATE INDEX "pricing_page_worked_example_parent_id_idx" ON "pricing_page_worked_example" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "pricing_page_worked_example_locales_locale_parent_id_unique" ON "pricing_page_worked_example_locales" USING btree ("_locale","_parent_id");
  CREATE UNIQUE INDEX "pricing_page_locales_locale_parent_id_unique" ON "pricing_page_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "faq_page_sections_items_order_idx" ON "faq_page_sections_items" USING btree ("_order");
  CREATE INDEX "faq_page_sections_items_parent_id_idx" ON "faq_page_sections_items" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "faq_page_sections_items_locales_locale_parent_id_unique" ON "faq_page_sections_items_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "faq_page_sections_order_idx" ON "faq_page_sections" USING btree ("_order");
  CREATE INDEX "faq_page_sections_parent_id_idx" ON "faq_page_sections" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "faq_page_sections_locales_locale_parent_id_unique" ON "faq_page_sections_locales" USING btree ("_locale","_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "careers_page_how_we_work" CASCADE;
  DROP TABLE "careers_page_how_we_work_locales" CASCADE;
  DROP TABLE "careers_page_product_family" CASCADE;
  DROP TABLE "careers_page_product_family_locales" CASCADE;
  DROP TABLE "careers_page_process" CASCADE;
  DROP TABLE "careers_page_process_locales" CASCADE;
  DROP TABLE "careers_page" CASCADE;
  DROP TABLE "careers_page_locales" CASCADE;
  DROP TABLE "press_page_fact_sheet" CASCADE;
  DROP TABLE "press_page_fact_sheet_locales" CASCADE;
  DROP TABLE "press_page_quotes" CASCADE;
  DROP TABLE "press_page_quotes_locales" CASCADE;
  DROP TABLE "press_page_story_angles_yes" CASCADE;
  DROP TABLE "press_page_story_angles_yes_locales" CASCADE;
  DROP TABLE "press_page_story_angles_no" CASCADE;
  DROP TABLE "press_page_story_angles_no_locales" CASCADE;
  DROP TABLE "press_page" CASCADE;
  DROP TABLE "press_page_locales" CASCADE;
  DROP TABLE "security_page_top_stats" CASCADE;
  DROP TABLE "security_page_top_stats_locales" CASCADE;
  DROP TABLE "security_page_posture" CASCADE;
  DROP TABLE "security_page_posture_locales" CASCADE;
  DROP TABLE "security_page_data_handling" CASCADE;
  DROP TABLE "security_page_data_handling_locales" CASCADE;
  DROP TABLE "security_page_compliance" CASCADE;
  DROP TABLE "security_page_compliance_locales" CASCADE;
  DROP TABLE "security_page" CASCADE;
  DROP TABLE "security_page_locales" CASCADE;
  DROP TABLE "pricing_page_principles" CASCADE;
  DROP TABLE "pricing_page_principles_locales" CASCADE;
  DROP TABLE "pricing_page_anti_patterns" CASCADE;
  DROP TABLE "pricing_page_anti_patterns_locales" CASCADE;
  DROP TABLE "pricing_page_worked_example" CASCADE;
  DROP TABLE "pricing_page_worked_example_locales" CASCADE;
  DROP TABLE "pricing_page" CASCADE;
  DROP TABLE "pricing_page_locales" CASCADE;
  DROP TABLE "faq_page_sections_items" CASCADE;
  DROP TABLE "faq_page_sections_items_locales" CASCADE;
  DROP TABLE "faq_page_sections" CASCADE;
  DROP TABLE "faq_page_sections_locales" CASCADE;
  ...
  DROP TYPE "public"."enum_trust_page_pillars_key";`)
}
