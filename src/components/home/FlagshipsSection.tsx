...
export function FlagshipsSection({ title, lead, flagships, seeAllLine }: Props) {
  return (
    <section id="flagships" className="px-4 sm:px-6 md:px-8 lg:px-12 py-16 md:py-20 lg:py-[120px] relative" style={{ borderTop: '1px solid var(--color-rule)' }}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-px mb-10" style={{ background: 'var(--color-rule)', border: '1px solid var(--color-rule)' }}>
