...
export function HeroCounter({ value, label, tagline, primaryCta, secondaryCta }: Props) {
  ...
  return (
    <section className="pt-[42px] min-h-screen flex flex-col justify-center relative px-12 pb-20">
      <div
        className="absolute start-12 end-12 top-[44%] h-px"
        style={{
          background:
      ...
      />
      <p
        className="text-[var(--color-mint)] text-[11px] uppercase tracking-[0.24em] mb-6 ps-[52px]"
      ...
      <div
        ...
        className="font-extralight leading-[0.94] tracking-[-0.04em] mb-8 ps-1"
      ...
      <div className="flex gap-[14px] ps-1">
        <a
          href="/manifesto"
